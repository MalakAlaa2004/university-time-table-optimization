...
class gbestPSO:
    def __init__(self, swarm_size, max_iterations, course_data, room_data, inertia, cognitive, social):
    ...
    def initialize_timetable_random(self, course_data, room_data):
        ...
        for course_id, (course_name, instructor_id) in course_data.items():
            room_id = np.random.randint(1, len(room_data)+1)  # Random valid room (1-20)
